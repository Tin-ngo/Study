   ...
   <body>
       ...
       <form method="post" enctype="multipart/form-data">
            ...
            <table align="left" width="400">
                ...
                <tr>
                    <td align="right">
                        <!--submit bao gồm value= idTL trong thẻ input type hidden-->
...
<?php   // ý nghĩa mấy câu if là nếu tồn tại thông tin được sửa thì gán thông tin vào biến để update lại
include_once('../connect.php');
// upload hinh anh
